  ...
  return (
    <div>
      <div className="min-h-screen bg-gray-100 flex flex-col justify-center py-12 sm:px-6 lg:px-8">
        ...
        <Card className="mt-8 sm:mx-auto sm:w-full sm:max-w-md mx-2">
          <div className="py-8 px-4 shadow rounded-md sm:px-10">
            ...
            <div className="mt-6">
              ...
              <div className="mt-6 grid grid-cols-3 gap-3">
                {iconSvgForm.map(
                  (iconItem: { iconTitle: string; iconElement: ReactNode }) => (
                    <div>
                      <Link
                        to="#"
                        className="w-full flex items-center justify-center px-8 py-3 border border-gray-300 rounded-md shadow-sm text-sm font-medium text-gray-700 bg-accent-foreground"
                      >
...
export default AppFormAuthLayout;
...
const iconSvgForm = [
  ...
  },
  {
    ...
    iconElement: (
      <>
        <svg
          className="w-5 h-5 sm:h-6 sm:w-6 fill-indigo-500"
          viewBox="0 0 24 24"
          fill="none"
