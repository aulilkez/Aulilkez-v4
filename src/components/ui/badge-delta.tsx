...
type DeltaTypeItems = "increase" | "decrease" | "neutral";
type IconStylesType = "filled" | "line";

const DeltaIcon = ({
  deltaType,
  iconStyle,
}: {
  deltaType: DeltaTypeItems | null;
  iconStyle: IconStylesType | null;
}) => {
  if (!deltaType || !iconStyle) return null;
  const icons = {
    increase: {
